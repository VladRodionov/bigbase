...
/**
 * The Class OffHeapCacheValueIterator.
 */
public class OffHeapCacheValueIterator implements Iterator<Object>{
	...
	/**
	 * Instantiates a new off heap cache value iterator.
	 *
	 * @param cache the cache
	 */
	OffHeapCacheValueIterator(OffHeapCache cache)
	{
		this.mCache = cache;
