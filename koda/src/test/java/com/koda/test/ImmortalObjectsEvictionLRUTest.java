...
public class ImmortalObjectsEvictionLRUTest extends TestCase{
  private final static Logger LOG = Logger
  .getLogger(ImmortalObjectsEvictionLRUTest.class);
  ...
  public void singleTest() throws KodaException, NativeMemoryException
  {
