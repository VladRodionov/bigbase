...
import org.yamm.core.ThreadLocalMalloc;
...
/**
 * The Class ThreadLocalNoCompactionStressTest.
 */
@SuppressWarnings("unused")

public class ThreadLocalNoCompactionStressTest
{
  ...
  private static byte[] getValue(int n, byte v){
	...
	public static void main(String[] args){
		int numThreads = 8;
		final long MAX_MEMORY = 200000000;
		MallocFactory factory = MallocNoCompactionFactory.getInstance(16, 64, 1.2D, MAX_MEMORY);
		final ThreadLocalMalloc malloc = new ThreadLocalMalloc(factory);
