...
/**
 * The Class UnsafeMallocTest.
 */
public class UnsafeMallocTest extends TestCase{
	...
	public void testTwo()
	{
		...
		um.free(mem);
		System.out.println("Allocd: "+UnsafeMalloc.address(mem)+" mem="+mem);		
	...
	public void testLargeAllocation()
	{
		...
		UnsafeMalloc um = new UnsafeMalloc(10000000);
	...
	public void testMallocUsableSize()
	{
		...
		UnsafeMalloc um = new UnsafeMalloc(15000000);
