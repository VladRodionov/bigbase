...
public class BaseTest extends TestCase{
  ...
  protected void createTables(int versions) {
    ...
    famA.setCacheDataOnWrite(true);
    famA.setCacheIndexesOnWrite(true);
    famA.setCacheBloomsOnWrite(true);
    famA.setBlocksize(BLOCK_SIZE);
    famA.setBloomFilterType(BloomType.ROW);
    
    HColumnDescriptor famB = new HColumnDescriptor(FAMILIES[1]);
    famB.setCacheDataOnWrite(true);
    famB.setMaxVersions(versions); 
    famB.setCacheDataOnWrite(true);
    famB.setCacheIndexesOnWrite(true);
    famB.setCacheBloomsOnWrite(true);
    ...
    famC.setCacheDataOnWrite(true);
    famC.setCacheDataOnWrite(true);
    famC.setCacheIndexesOnWrite(true);
    famC.setCacheBloomsOnWrite(true);
