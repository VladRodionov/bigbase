 ...
 */
public class FileMultiStorageBasicTest extends FileMultiStorageBaseTest{

	/** The Constant LOG. */
	static final Log LOG = LogFactory.getLog(FileMultiStorageBasicTest.class);
	...
	public void testPutGet() throws NativeMemoryException, IOException
	{
		...
		assertEquals(0, handle.getId() & 0xffffff);
