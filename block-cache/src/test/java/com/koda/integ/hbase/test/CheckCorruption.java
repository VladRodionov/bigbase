...
/**
 * The Class CheckCorruption.
 */
public class CheckCorruption {
	
	/** The Constant LOG. */
	private final static Logger LOG = Logger.getLogger(CheckCorruption.class);
	...
	private static void verifyFile(String[] args) throws IOException{
		...
		int offsetTo = Integer.parseInt(args[1]);
		int sizeTo = Integer.parseInt(args[2]);
		...
		LOG.info("File: "+fileName+" - OK. Total records ="+recordNumber+" found= "+offsetFound);
