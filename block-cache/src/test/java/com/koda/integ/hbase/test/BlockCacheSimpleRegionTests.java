 ...
 */
public class BlockCacheSimpleRegionTests extends TestCase{
  
  /** The Constant LOG. */
  final static Log LOG = LogFactory.getLog(BlockCacheSimpleRegionTests.class);
  ...
  /** The cache size. */
  private static long cacheSize = 8000000000L; // 2G
  ...
  protected void setUp() throws IOException
  {
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public void _testSequentialRead() throws IOException
    {
    ...
    public void testRandomRead() throws IOException
    {
      ...
      for(int i=0; i < N ; i++){
        ...
        //System.out.println(i+"| "+get+" nulls="+nulls);
...
//    }
    ...
    {
      BlockCacheSimpleRegionTests test = new BlockCacheSimpleRegionTests();
      test.setUp();
      //test._testRandomRead();
      for(int i=0; i < 1000; i++){
        test._testStoreFileScanner();
      }
    }
}
